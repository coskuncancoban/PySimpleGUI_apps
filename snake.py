...
def convert_pos_to_pixel(cell):
    tl = cell[0] * CELL_SIZE, cell[1] * CELL_SIZE # top left
    br = tl[0] + CELL_SIZE, tl[1] + CELL_SIZE #bottom right
    return tl, br
...
field = sg.Graph(
    ...
    graph_bottom_left = (0,0), # origin point of graph.
    graph_top_right = (FIELD_SIZE,FIELD_SIZE), # most distant point to origin.
...
while True:
    ...
    if time_since_start >= 0.5:
        ...
        for index, part in enumerate(snake_body):
            ...
            color = 'white' if index == 0 else 'gray'
